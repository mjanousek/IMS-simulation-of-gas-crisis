...
Modelového času (přednáška IMS 25.9.2014 \cite[str. 21]{IMS}), pro účeli tohoto modelu lze tedy docílit
jednoduše vykonáním všech událostí se stejným počátečním časem v jedné iteraci cyklu.
...
Všechny vzorce a zdroje jsou uvedeny v kapetole \ref{Rozbor} 
...
\begin{tabular}{|l|r|}
    \hline
    Stát 			& Maximální kapacita zásobníků\\
    \hline 
...
\begin{tabular}{|l|l|l|r|}
    ...
    \hline
\end{tabular}
\caption{Délka uvažovaných plynovodů. Zdroj \cite{plynovody}} 
\label{plynovody}
\end{center}
\end{table}
...
Současná potrubní síť na přepravu plynu je
mezi jednotlivými státy svojí přepravní kapacitou dostačující 
i po připojení výše zmiňovaných terminálů na zkapalněný zemní plyn, tudíž není
třeba uvažovat její potřebné rozšíření.

Jedinou informací, kterou je třeba dále doplnit o terminálech na LNG,
je vzdálenost terminálu na ostrově Krk od námi zkoumané nejbližší země a tou je Maďarsko. 
Tato vzdálenost činní 440 km\footnote{Hodnoty změřené za pomoci webové stránky \textit{Mapy.cz} (www.Mapy.cz)} a čas potřebný k překonání vzdálenosti je 6 hodin.
...
\bibitem{plynovody}Gasprom [online]. [cit. 2014-12-07]. Dostupné z: http://www.gazprom.com/
