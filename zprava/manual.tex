...
\end{tabular}
\caption{Veškeré hodnoty jsou uvedeny v jednotkách $m^3 * 10^6$ za jeden rok.
Zdroj \cite{IEA}}
\label{tabulka1}
\end{center}
\end{table}
...
\end{tabular}
\caption[LOL]{Veškeré hodnoty jsou uvedeny v jednotkách $m^3 * 10^3$ za hodinu\footnotemark}
\label{tabulka2}
\end{center}
\end{table}
...
a z jiného zdroje přesně neodpovídaly nalezeným hodnotám z primátnáho zdroje
(viz tabulka \ref{tabulka1}),
byl poměr zimní a letní spotřeby získán z mapy \cite{Mapka staty} a posléze aplikován
na hodnoty v tabulce \ref{tabulka1}.
...
\begin{tabular}{|l|r|r|r|r|}
    ...
    \hline 
    Česká republika	& 968	& 0.2858   	& 553	& 1382\\ 
    Slovensko 		& 664	& 0.2903		& 385	& 942\\
    Maďarsko 		& 1 053	& 0.2747		& 578	& 1526\\
    Polsko 			& 2 081	& 0.3935		& 1637	& 2524\\
    Ukrajina 		& 5 882	& 0.2745		& 3229	& 8535\\
    \hline
\end{tabular}
\caption[LOL]{Veškeré hodnoty jsou uvedeny v jednotkách $m^3 * 10^3$ za hodinu}
\label{tabulka3}
\end{center}
\end{table} 
...
\begin{tabular}{|c|r|}
    ...
    \hline
\end{tabular}
\caption[LOL]{Veškeré hodnoty jsou uvedeny v jednotkách $m^3 * 10^6$}
\label{tabulka4}
\end{center}
\end{table}
...
Jako rychlost zemního plynu byla zvolena hodnota 20 m/s získaná ze zdroje
\cite{engineering}.
...
Kritéria pro výběr nejvhodnějších lodní terminály byla existence potrubní sítě s
...
\begin{tabular}{|c|c|r|r|r|}
    \hline
    Stát		& Místo			& Kapacita 		& Očekávaná kapacita ročního odběru & rok dokončení\\
    \hline 
    ...
    \hline
\end{tabular}
\caption{Veškeré hodnoty jsou uvedeny v jednotkách }
\label{tabulka4}
\end{center}
\end{table}
